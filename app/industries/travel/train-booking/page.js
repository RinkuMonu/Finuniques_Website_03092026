...
const features = [
  {
    icon: Send,
    title: "Rail Fare Collections",
    description:
      "Collect payments for tickets, seat classes and add-ons in one smooth booking journey.",
  },
  {
    icon: ArrowLeftRight,
    title: "Change and Refund Control",
    description:
      "Manage cancellations, schedule changes and refunds with clear transaction status.",
  },
  {
    icon: BarChart3,
    title: "Rail Reporting",
    description:
      "Track bookings, payment performance and partner settlements from one place.",
  },
];
...
const bookingSteps = [
  [
    "01",
    "Choose the journey",
    "Let travelers select routes, classes, seats and passenger details in a clear flow.",
  ],
  [
    "02",
    "Confirm the ticket",
    "Accept secure payment and keep ticket issuance aligned with the booking status.",
  ],
  [
    "03",
    "Reconcile the route",
    "Match ticket sales, refunds and settlements across routes and travel partners.",
  ],
];
        ...
        <div className="relative mx-auto grid max-w-[1580px] items-center gap-12 px-6 py-20 sm:px-10 sm:py-28 lg:grid-cols-[1fr_.9fr] lg:px-16 lg:py-32">
          ...
          >
            ...
            <h1 className="mt-6 max-w-3xl text-5xl font-black leading-[1.02] tracking-[-0.04em] sm:text-6xl lg:text-7xl">
              Make every rail booking feel effortless.
            </h1>
            <p className="mt-7 max-w-2xl text-lg leading-8 text-white/70">
              Build dependable train booking journeys with secure payments,
              instant confirmation and controls for changes, cancellations and
              refunds.
            </p>
            ...
            <div className="relative rounded-[28px] border border-white/15 bg-white p-5 text-[#073B4C] shadow-[0_30px_80px_rgba(0,0,0,.24)]">
              <div className="flex items-center justify-between border-b border-slate-100 pb-5">
                <div>
                  ...
                  <p className="mt-1 text-xl font-black">Mumbai to Ahmedabad</p>
                </div>
              ...
              <div className="mt-5 grid gap-3">
                <div className="flex items-center justify-between rounded-xl bg-[#EEF8FC] p-4">
                  ...
                  <strong>06:15 AM</strong>
                </div>
                <div className="flex items-center justify-between rounded-xl bg-[#EEF8FC] p-4">
                  <span className="text-sm font-bold text-slate-500">
                    Class
                  </span>
                  <strong>AC 2 Tier · 1 passenger</strong>
                </div>
                <div className="flex items-center justify-between rounded-xl bg-[#EEF8FC] p-4">
                  <span className="text-sm font-bold text-slate-500">
                    Total fare
        ...
        <div className="relative mx-auto max-w-[1580px] px-6 sm:px-10 lg:px-16">
          ...
          >
            ...
            <h2 className="text-4xl font-bold leading-[1.08] tracking-[-0.04em] text-[#073B4C] sm:text-5xl lg:text-6xl xl:text-[64px]">
              Built for modern rail journeys.
            </h2>
          </motion.div>
        ...
        <div className="mx-auto max-w-[1580px] px-6 sm:px-10 lg:px-16">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-5 text-4xl font-black tracking-tight sm:text-5xl">
              A smoother journey from search to ticket.
            </h2>
          </div>

...
const features = [
  {
    icon: Send,
    title: "Reservation Collections",
    description:
      "Collect room charges, deposits and add-ons across direct and partner booking channels.",
  },
  {
    icon: ArrowLeftRight,
    title: "Stay Change Control",
    description:
      "Manage cancellations, date changes and refunds while keeping guests informed.",
  },
  {
    icon: BarChart3,
    title: "Property Reporting",
    description:
      "Track reservations, payment performance and property settlements from one place.",
  },
];
...
const bookingSteps = [
  [
    "01",
    "Select the stay",
    "Let guests choose rooms, dates, packages and extras in a clear reservation flow.",
  ],
  [
    "02",
    "Secure the booking",
    "Collect deposits or full payment and return confirmation without unnecessary friction.",
  ],
  [
    "03",
    "Settle the property",
    "Reconcile commissions, refunds and property payouts with accurate booking records.",
  ],
];
...
const metrics = [
  ...
  ["24/7", "Guest support", CheckCircle2],
];
        ...
        <div className="relative mx-auto grid max-w-[1580px] items-center gap-12 px-6 py-20 sm:px-10 sm:py-28 lg:grid-cols-[1fr_.9fr] lg:px-16 lg:py-32">
          ...
          >
            ...
            <h1 className="mt-6 max-w-3xl text-5xl font-black leading-[1.02] tracking-[-0.04em] sm:text-6xl lg:text-7xl">
              Turn room searches into confident stays.
            </h1>
            <p className="mt-7 max-w-2xl text-lg leading-8 text-white/70">
              Accept reservations, deposits and add-on payments with a booking
              experience that works for guests, properties and travel platforms.
            </p>
            ...
            <div className="relative rounded-[28px] border border-white/15 bg-white p-5 text-[#073B4C] shadow-[0_30px_80px_rgba(0,0,0,.24)]">
              <div className="flex items-center justify-between border-b border-slate-100 pb-5">
                <div>
                  ...
                  <p className="mt-1 text-xl font-black">Goa beachfront stay</p>
                </div>
              ...
              <div className="mt-5 grid gap-3">
                ...
                <div className="flex items-center justify-between rounded-xl bg-[#EEF8FC] p-4">
                  ...
                  <strong>Ocean suite · 2 nights</strong>
                </div>
                <div className="flex items-center justify-between rounded-xl bg-[#EEF8FC] p-4">
                  <span className="text-sm font-bold text-slate-500">
                    Total stay
        ...
        <div className="mx-auto max-w-[1580px] px-6 sm:px-10 lg:px-16">
          <div className="max-w-2xl">
            ...
            <h2 className="mt-5 text-4xl font-black tracking-tight sm:text-5xl">
              A smoother journey from search to check-in.
            </h2>
          </div>
